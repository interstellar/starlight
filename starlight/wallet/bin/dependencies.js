...
const outputPath = path.join(process.cwd(), 'node_modules/starlight-react-dlls')
...
exec(
  'webpack --display-chunks --display-error-details --color --config webpack/webpack.dll.js'
)
